## Kryptogewerbe, Mining und Steuern
...
| **KG**                | Ähnlich OHG, jedoch mit Komplementären (volle Haftung) und Kommanditisten (Teilhafter). Betrifft beide Gruppen, solange die Coins im KG-Betriebsvermögen liegen. | Eine KG kauft 5.000 ADA und hält sie 2 Jahre. Auch nach Ablauf von 2 Jahren sind Gewinne aus dem Verkauf steuerpflichtig (Betriebsvermögen). |
| **UG/GmbH (KapGes)**  | Kapitalgesellschaften können niemals die 1-jährige Spekulationsfrist nutzen; Veräußerungen werden stets versteuert. | Eine GmbH kauft und verkauft ADA nach 2 Jahren mit Gewinn – sie zahlt Körperschaftsteuer und Gewerbesteuer auf den Gewinn. |


---

## 5. Einbringung privater Tokens in das Unternehmen

Werden private Coins oder Tokens ins Betriebsvermögen eingebracht, verlieren sie den **privaten** Charakter; ggf. entfallen Haltefrist-Vorteile und andere Privateinkunfts-Regelungen.

| **Rechtsform**        | **Regelung / Besonderheit**                                  | **Praxisbeispiel**                                           |
| --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Einzelunternehmer** | Keine echte „Einbringung“ möglich, da Privat- und Betriebsvermögen derselben Person gehören. Sobald Tokens betrieblich genutzt werden, sind sie dem Betriebsvermögen zuzuordnen. | Max nutzt seine zuvor privat gehaltenen ADA nun für sein gewerbliches Staking. Damit gelten sie als Betriebsvermögen. |
| **GbR**               | Tokens können als Einlage in die GbR eingebracht werden. Damit entfallen private Haltefristen und werden zu GbR-Vermögen. | Zwei Gesellschafter beschließen, privat gehaltene ADA in die GbR einzubringen. Ab diesem Zeitpunkt sind die Coins eindeutig betriebliche Assets. |
| **OHG**               | Vergleichbar mit der GbR, allerdings i. d. R. gewerblich. Die Einbringung wird wie eine Kapitaleinlage behandelt. | Die OHG erhält eine Einlage von 2.000 ADA, die ein Gesellschafter bisher privat hatte. Nun gelten die ADA als Betriebsvermögen der OHG. |
| **KG**                | Auch hier gibt es Einlagen von Komplementären und/oder Kommanditisten. Alles, was eingebracht wird, gehört dem Gesellschaftsvermögen. | Ein Kommanditist bringt 1.000 ADA ein, die zuvor privat gehalten wurden. Ab sofort zählen sie zum Betriebsvermögen der KG. |
